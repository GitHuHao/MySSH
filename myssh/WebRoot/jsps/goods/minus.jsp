...
<script type="text/javascript">
	$(function(){
		$("#amount").blur(function(){
			...
			new_amount = $(this).val();
			if(isNaN(new_amount) || new_amount<0||origin_amount<new_amount){
...
<body>
	...
	<table border="0" width="100%" cellpadding="0" cellspacing="0">
		<tr valign="top">
			<td rowspan="2">
				<s:form id="goods_minus" name="select" namespace="/goods" action="goods_minus.action" method="post" theme="simple"> 
					<table width="100%" border="0" cellpadding="0" cellspacing="0" class="tx" align="center">
						...
						<tr>
							<td colspan="2" align="center" style="padding-top:10px;">
								<s:submit id="sub" cssClass="tx" cssStyle="width:120px;margin-right:30px;" value="出库" />
