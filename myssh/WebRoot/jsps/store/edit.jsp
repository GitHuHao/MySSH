...
<body>
	...
	<table border="0" width="100%" cellpadding="0" cellspacing="0">
		<tr valign="top">
			<td rowspan="2">
				<s:form action="store_edit" namespace="/" method="post" theme="simple" name="select">
					<table width="100%" border="0" cellpadding="0" cellspacing="0" class="tx" align="center">
						...
						<tr>
							...
							<td>
								...
								<s:textfield cssClass="tx" name="name" value="%{model.name}"></s:textfield>
							</td>
						</tr>
						<tr>
							<td>
							...
							<td>
								<s:textfield cssClass="tx" name="addr" value="%{model.addr}"></s:textfield>
							</td>
						</tr>
						<tr>
							<td>
							...
							<td>
								<s:textfield cssClass="tx" name="manager" value="%{model.manager}"></s:textfield>
							</td>
						</tr>
						<tr>
